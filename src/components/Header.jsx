...
import SawLogo from '../assets/saw2.png'
...
export const Header = () => {
    ...
    return (
        <header>
            <nav className="bg-white px-2 py-2 border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b dark:border-gray-900">
                <div className="flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className="flex md:order-2">
                        ...
                        <button type="button" onClick={() => setHidden(!hidden)} className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false">
                    ...
                    {/*Hidden Search Bar and Menu Links*/}
